<div>
    <span class="font-weight-bold fs-3 m-3">Manage Loan Requests</span>
    ...
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-end">
            <span class="me-3">
                <button type="button" class="btn btn-dark"    data-bs-toggle="modal" data-bs-target="#exampleModal">Apply for Loan</button>
            </span>
            <span class="me-3">
                ...
                <table id="example" class="table table-striped table-borderless border p-3"  style="border-collapse: separate; border-spacing: 0; border-radius: 10px; overflow: hidden; width:100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">Not Working</td>
                            <td class="text-center">M61</td>
                            <td class="text-center">12 Aug 2023, 13:50</td>
                            <td class="text-center">
                                <span class="badge badge-pill p-2" style="background-color: #fff3cd; color: #856404;">
                                    Pending
                                </span>                                
                            </td>
                            <td>
